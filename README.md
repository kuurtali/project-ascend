...
| **Decisions are the artifact** | 67 decision records with reasoning, including the wrong turns. `docs/SECOND_BRAIN.md`. |
...
67 decision records, written in Turkish. Highlights:
